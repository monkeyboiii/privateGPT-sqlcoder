...
preset = os.environ.get("PROMPT_PRESET", "example")
...
def parse_arguments():
    ...
    parser.add_argument("-S", "--hide-source", action='store_true',
                        help='Use this flag to disable printing of source documents used for answers.')

    parser.add_argument("-M", "--mute-stream",
                        action='store_true',
